...
def parse_args():
    ...
    manual_parser.add_argument("--type",help="Type of run",choices=["Easy","Threshold","Long","Aerobic","Race"],required=True)
    ...
    # import specific
    import_parser.add_argument("--path",help="Path to zip or unzipped file")
    # list specific
